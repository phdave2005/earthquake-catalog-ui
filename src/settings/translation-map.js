...
export const TEXT_MAP = {
    ...
    de: {
        about: {
            dvp: 'Über David',
            ehp: 'Über das Erdbebengefahrenprogramm'
        },
    ...
    en: {
        about: {
            dvp: 'About DVP',
            ehp: 'About Earthquake Hazards Program'
        },
        heading: 'Settings',
        label: {
    ...
    hi: {
        about: {
            ...
            ehp: 'भूकंप खतरा कार्यक्रम के बारे में'
        },
        heading: 'समायोजन',
        label: {
    ...
    it: {
        about: {
            dvp: 'Di DVP',
            ehp: 'Informazioni sul programma'
        },
    ...
    ru: {
        about: {
            dvp: 'О Дэвиде',
            ehp: 'О программе по предотвращению землетрясений'
        },
        heading: 'Настройки',
        label: {
